...
(function () {
  ...
  var DICT = {
    en: {
      ...
      hero_lead: 'DoseTrace is a private journal and calculator for peptides, TRT, and supplements. Log doses, track vials, chart your bloodwork, and run the numbers — synced securely across your devices.',
      hero_tagline: 'Transparent math — it never interprets or advises.',
      hero_note: 'Free to use · No ads · Your data is never sold',
      sb_get_small: 'Download on the', sb_play_small: 'Get it on',
      trust_private: 'Private by default', trust_offline: 'Encrypted sync', trust_noads: 'No ads, never sold', trust_langs: '6 languages', trust_notmed: 'Not a medical service',
      ...
      f1_t: 'Dose &amp; protocol tracking', f1_d: 'Log every dose, set your schedule, and keep a clean history. Optional reminders for your schedule.',
      f2_t: 'Vials &amp; syringe math', f2_d: 'Track vial supply and reconstitution. Syringe units from the numbers you enter. The arithmetic, done for you.',
      ...
      f6_t: 'Private by default', f6_d: 'Your data syncs securely to your private account so it is backed up across your devices. No ads, and your health data is never sold or shared.',
      screens_eyebrow: 'A closer look', screens_h2: 'Calm, clear, and quick to read.', screens_sub: 'Swipe through the app.',
      cap0: 'See your lab markers over time', cap1: 'Your day at a glance', cap2: 'Protocols &amp; vials', cap3: 'Records &amp; insights', cap4: 'Energy &amp; protein', cap5: 'A real reality check',
      priv_eyebrow: 'Privacy', priv_h2: 'Your data stays yours.',
      priv_lead: 'Your data lives on your device and syncs, encrypted in transit, to your private account — so it is backed up and available across your devices.',
      priv_c1: '<b>On your device and synced</b> — to your private, encrypted account.',
      ...
      priv_stat: 'Never<span> sold or shared</span>',
      ...
      prem_1: 'Everything in Free', prem_2: 'Unlimited protocols', prem_3: 'Unlimited AI lab &amp; vaccine scanning — photo or PDF, any language', prem_4: 'PDF export for your doctor', prem_5: 'Reality-check &amp; progress tracking', prem_7: 'Priority support', prem_8: 'Dose accumulation &amp; serum-curve charts',
      prem_note: 'Monthly, annual, or one-time lifetime. Cancel anytime.',
      faq_eyebrow: 'Questions', faq_h2: 'Frequently asked',
      q1_q: 'Is DoseTrace free?', q1_a: 'Yes. Dose tracking, reminders, up to 3 protocols, the calculators, lab &amp; vaccine journals, cloud sync, and one AI lab scan are all free. Premium unlocks unlimited protocols, unlimited scanning, PDF export, and progress tracking — with a free trial.',
      q2_q: 'Is my data private?', q2_a: 'Your data lives on your device and syncs, encrypted in transit, to your private account. There are no ads, and your health data is never sold or shared. You can delete everything from the app at any time.',
    ...
    es: {
      ...
      hero_lead: 'DoseTrace es un diario privado y una calculadora para péptidos, TRT y suplementos. Registra dosis, controla viales, grafica tus análisis y haz los cálculos — sincronizado de forma segura en tus dispositivos.',
      hero_tagline: 'Matemática transparente: nunca interpreta ni aconseja.',
      hero_note: 'Gratis · Sin anuncios · Tus datos nunca se venden',
      sb_get_small: 'Descárgala en el', sb_play_small: 'Disponible en',
      trust_private: 'Privado por defecto', trust_offline: 'Sincronización cifrada', trust_noads: 'Sin anuncios, nunca se vende', trust_langs: '6 idiomas', trust_notmed: 'No es un servicio médico',
      ...
      f1_t: 'Registro de dosis y protocolos', f1_d: 'Registra cada dosis, define tu calendario y mantén un historial claro. Recordatorios opcionales para tu calendario.',
      f2_t: 'Viales y cálculo de jeringa', f2_d: 'Controla el suministro y la reconstitución de viales. Unidades de jeringa a partir de los números que introduces. La aritmética, hecha por ti.',
      ...
      f6_t: 'Privado por defecto', f6_d: 'Tus datos se sincronizan de forma segura con tu cuenta privada para tener copia de seguridad en tus dispositivos. Sin anuncios, y tus datos de salud nunca se venden ni se comparten.',
      screens_eyebrow: 'Una mirada de cerca', screens_h2: 'Tranquila, clara y fácil de leer.', screens_sub: 'Desliza por la app.',
      cap0: 'Tus marcadores de laboratorio con el tiempo', cap1: 'Tu día de un vistazo', cap2: 'Protocolos y viales', cap3: 'Registros e información', cap4: 'Energía y proteína', cap5: 'Un chequeo real',
      priv_eyebrow: 'Privacidad', priv_h2: 'Tus datos siguen siendo tuyos.',
      priv_lead: 'Tus datos viven en tu dispositivo y se sincronizan, cifrados en tránsito, con tu cuenta privada — para tener copia de seguridad y disponibilidad en tus dispositivos.',
      priv_c1: '<b>En tu dispositivo y sincronizado</b> — con tu cuenta privada y cifrada.',
      ...
      priv_stat: 'Nunca<span> vendidos ni compartidos</span>',
      ...
      prem_1: 'Todo lo de Gratis', prem_2: 'Protocolos ilimitados', prem_3: 'Escaneo ilimitado de análisis y vacunas con IA — foto o PDF, cualquier idioma', prem_4: 'Exportación en PDF para tu médico', prem_5: 'Chequeo real y seguimiento del progreso', prem_7: 'Soporte prioritario', prem_8: 'Acumulación de dosis y curvas séricas',
      prem_note: 'Mensual, anual o pago único de por vida. Cancela cuando quieras.',
      faq_eyebrow: 'Preguntas', faq_h2: 'Preguntas frecuentes',
      q1_q: '¿DoseTrace es gratis?', q1_a: 'Sí. El registro de dosis, los recordatorios, hasta 3 protocolos, las calculadoras, los diarios de análisis y vacunas, la sincronización en la nube y un escaneo de análisis con IA son gratis. Premium desbloquea protocolos y escaneos ilimitados, exportación PDF y seguimiento del progreso — con prueba gratuita.',
      q2_q: '¿Mis datos son privados?', q2_a: 'Tus datos viven en tu dispositivo y se sincronizan, cifrados en tránsito, con tu cuenta privada. No hay anuncios y tus datos de salud nunca se venden ni se comparten. Puedes borrarlo todo desde la app cuando quieras.',
    ...
    pt: {
      ...
      hero_lead: 'DoseTrace é um diário privado e uma calculadora para peptídeos, TRT e suplementos. Registre doses, controle frascos, acompanhe seus exames e faça as contas — sincronizado com segurança entre seus aparelhos.',
      hero_tagline: 'Matemática transparente: nunca interpreta nem aconselha.',
      hero_note: 'Grátis · Sem anúncios · Seus dados nunca são vendidos',
      sb_get_small: 'Baixar na', sb_play_small: 'Disponível no',
      trust_private: 'Privado por padrão', trust_offline: 'Sincronização cifrada', trust_noads: 'Sem anúncios, nunca vendido', trust_langs: '6 idiomas', trust_notmed: 'Não é um serviço médico',
      ...
      f1_t: 'Registro de doses e protocolos', f1_d: 'Registre cada dose, defina seu cronograma e mantenha um histórico limpo. Lembretes opcionais para o seu cronograma.',
      f2_t: 'Frascos e cálculo de seringa', f2_d: 'Controle o estoque e a reconstituição dos frascos. Unidades de seringa a partir dos números que você insere. A aritmética, feita para você.',
      ...
      f6_t: 'Privado por padrão', f6_d: 'Seus dados são sincronizados com segurança para sua conta privada, com backup entre seus aparelhos. Sem anúncios, e seus dados de saúde nunca são vendidos ou compartilhados.',
      screens_eyebrow: 'De perto', screens_h2: 'Calmo, claro e rápido de ler.', screens_sub: 'Deslize pelo app.',
      cap0: 'Seus marcadores de exames ao longo do tempo', cap1: 'Seu dia num relance', cap2: 'Protocolos e frascos', cap3: 'Registros e insights', cap4: 'Energia e proteína', cap5: 'Um teste de realidade',
      priv_eyebrow: 'Privacidade', priv_h2: 'Seus dados continuam seus.',
      priv_lead: 'Seus dados ficam no seu aparelho e são sincronizados, criptografados em trânsito, com sua conta privada — para ter backup e disponibilidade entre seus aparelhos.',
      priv_c1: '<b>No seu aparelho e sincronizado</b> — com sua conta privada e criptografada.',
      ...
      priv_stat: 'Nunca<span> vendidos ou compartilhados</span>',
      ...
      prem_1: 'Tudo do Grátis', prem_2: 'Protocolos ilimitados', prem_3: 'Leitura ilimitada de exames e vacinas com IA — foto ou PDF, qualquer idioma', prem_4: 'Exportação em PDF para seu médico', prem_5: 'Teste de realidade e acompanhamento', prem_7: 'Suporte prioritário', prem_8: 'Acumulação de dose e curvas séricas',
      ...
      q1_q: 'O DoseTrace é grátis?', q1_a: 'Sim. Registro de doses, lembretes, até 3 protocolos, as calculadoras, diários de exames e vacinas, sincronização na nuvem e uma leitura de exame com IA são grátis. O Premium libera protocolos e leituras ilimitados, exportação PDF e acompanhamento — com teste grátis.',
      q2_q: 'Meus dados são privados?', q2_a: 'Seus dados ficam no seu aparelho e são sincronizados, criptografados em trânsito, com sua conta privada. Não há anúncios e seus dados de saúde nunca são vendidos ou compartilhados. Você pode apagar tudo pelo app quando quiser.',
    ...
    fr: {
      ...
      hero_lead: "DoseTrace est un journal privé et un calculateur pour les peptides, la TRT et les compléments. Enregistrez les doses, suivez les flacons, tracez vos analyses et faites les calculs — synchronisé en toute sécurité sur vos appareils.",
      hero_tagline: "Des calculs transparents : jamais d’interprétation ni de conseil.",
      ...
      trust_private: 'Privé par défaut', trust_offline: 'Synchro chiffrée', trust_noads: 'Sans pub, jamais vendu', trust_langs: '6 langues', trust_notmed: "Pas un service médical",
      ...
      f1_t: 'Suivi des doses et protocoles', f1_d: "Enregistrez chaque dose, définissez votre calendrier et gardez un historique clair. Des rappels optionnels pour votre calendrier.",
      f2_t: 'Flacons et calcul de seringue', f2_d: "Suivez le stock et la reconstitution des flacons. Les unités de seringue à partir des chiffres que vous saisissez. L’arithmétique, faite pour vous.",
      ...
      f6_t: 'Privé par défaut', f6_d: "Vos données sont synchronisées en toute sécurité vers votre compte privé, avec sauvegarde sur vos appareils. Sans pub, et vos données de santé ne sont jamais vendues ni partagées.",
      screens_eyebrow: 'De plus près', screens_h2: 'Calme, clair et rapide à lire.', screens_sub: "Faites défiler l’app.",
      cap0: 'Vos marqueurs de laboratoire dans le temps', cap1: 'Votre journée en un coup d’œil', cap2: 'Protocoles et flacons', cap3: 'Registres et repères', cap4: 'Énergie et protéines', cap5: 'Un vrai bilan',
      priv_eyebrow: 'Confidentialité', priv_h2: 'Vos données restent les vôtres.',
      priv_lead: "Vos données restent sur votre appareil et sont synchronisées, chiffrées en transit, avec votre compte privé — pour être sauvegardées et disponibles sur vos appareils.",
      priv_c1: '<b>Sur votre appareil et synchronisé</b> — avec votre compte privé et chiffré.',
      ...
      priv_stat: 'Jamais<span> vendues ni partagées</span>',
      ...
      prem_1: 'Tout le Gratuit', prem_2: 'Protocoles illimités', prem_3: 'Scan illimité d’analyses et vaccins par IA — photo ou PDF, toute langue', prem_4: 'Export PDF pour votre médecin', prem_5: 'Bilan réel et suivi des progrès', prem_7: 'Support prioritaire', prem_8: 'Accumulation des doses et courbes sériques',
      ...
      q1_q: 'DoseTrace est-il gratuit ?', q1_a: "Oui. Le suivi des doses, les rappels, jusqu’à 3 protocoles, les calculateurs, les journaux d’analyses et vaccins, la synchro cloud et un scan d’analyse IA sont gratuits. Premium débloque protocoles et scans illimités, export PDF et suivi des progrès — avec essai gratuit.",
      q2_q: 'Mes données sont-elles privées ?', q2_a: "Vos données restent sur votre appareil et sont synchronisées, chiffrées en transit, avec votre compte privé. Aucune pub, et vos données de santé ne sont jamais vendues ni partagées. Vous pouvez tout supprimer depuis l’app à tout moment.",
    ...
    de: {
      ...
      hero_lead: 'DoseTrace ist ein privates Journal und ein Rechner für Peptide, TRT und Nahrungsergänzung. Erfasse Dosen, verfolge Vials, visualisiere dein Blutbild und rechne alles durch — sicher über deine Geräte hinweg synchronisiert.',
      hero_tagline: 'Transparente Berechnungen — nie Deutung, nie Rat.',
      hero_note: 'Kostenlos · Keine Werbung · Deine Daten werden nie verkauft',
      sb_get_small: 'Laden im', sb_play_small: 'Jetzt bei',
      trust_private: 'Privat von Haus aus', trust_offline: 'Verschlüsselte Sync', trust_noads: 'Keine Werbung, nie verkauft', trust_langs: '6 Sprachen', trust_notmed: 'Kein medizinischer Dienst',
      ...
      f1_t: 'Dosen- &amp; Protokoll-Tracking', f1_d: 'Erfasse jede Dosis, lege deinen Zeitplan fest und behalte eine saubere Historie. Optionale Erinnerungen für deinen Zeitplan.',
      f2_t: 'Vials &amp; Spritzen-Mathematik', f2_d: 'Verfolge Vial-Vorrat und Rekonstitution. Spritzen-Einheiten aus den Zahlen, die du eingibst. Die Rechnung — für dich erledigt.',
      ...
      f6_t: 'Privat von Haus aus', f6_d: 'Deine Daten werden sicher mit deinem privaten Konto synchronisiert und über deine Geräte hinweg gesichert. Keine Werbung, und deine Gesundheitsdaten werden nie verkauft oder geteilt.',
      screens_eyebrow: 'Aus der Nähe', screens_h2: 'Ruhig, klar und schnell erfassbar.', screens_sub: 'Wisch dich durch die App.',
      cap0: 'Deine Laborwerte im Zeitverlauf', cap1: 'Dein Tag auf einen Blick', cap2: 'Protokolle &amp; Vials', cap3: 'Aufzeichnungen &amp; Einblicke', cap4: 'Energie &amp; Protein', cap5: 'Ein echter Realitäts-Check',
      priv_eyebrow: 'Datenschutz', priv_h2: 'Deine Daten bleiben deine.',
      priv_lead: 'Deine Daten liegen auf deinem Gerät und werden – verschlüsselt bei der Übertragung – mit deinem privaten Konto synchronisiert, sodass sie gesichert und auf deinen Geräten verfügbar sind.',
      priv_c1: '<b>Auf deinem Gerät und synchronisiert</b> — mit deinem privaten, verschlüsselten Konto.',
      ...
      priv_stat: 'Nie<span> verkauft oder geteilt</span>',
      ...
      prem_1: 'Alles aus Kostenlos', prem_2: 'Unbegrenzte Protokolle', prem_3: 'Unbegrenztes KI-Scannen von Labor &amp; Impfungen — Foto oder PDF, jede Sprache', prem_4: 'PDF-Export für deine Ärztin/deinen Arzt', prem_5: 'Realitäts-Check &amp; Fortschritt', prem_7: 'Priorisierter Support', prem_8: 'Dosis-Akkumulation &amp; Serumkurven',
      prem_note: 'Monatlich, jährlich oder einmalig auf Lebenszeit. Jederzeit kündbar.',
      faq_eyebrow: 'Fragen', faq_h2: 'Häufige Fragen',
      q1_q: 'Ist DoseTrace kostenlos?', q1_a: 'Ja. Dosen-Tracking, Erinnerungen, bis zu 3 Protokolle, die Rechner, Labor- &amp; Impf-Journale, Cloud-Sync und ein KI-Laborscan sind kostenlos. Premium schaltet unbegrenzte Protokolle, unbegrenztes Scannen, PDF-Export und Fortschritt frei — mit kostenloser Testphase.',
      q2_q: 'Sind meine Daten privat?', q2_a: 'Deine Daten liegen auf deinem Gerät und werden, verschlüsselt bei der Übertragung, mit deinem privaten Konto synchronisiert. Es gibt keine Werbung, und deine Gesundheitsdaten werden nie verkauft oder geteilt. Du kannst jederzeit alles in der App löschen.',
    ...
    it: {
      ...
      hero_lead: 'DoseTrace è un diario privato e un calcolatore per peptidi, TRT e integratori. Registra le dosi, monitora i flaconi, traccia le analisi e fai i conti — sincronizzato in sicurezza su tutti i tuoi dispositivi.',
      hero_tagline: 'Matematica trasparente: non interpreta né consiglia mai.',
      hero_note: 'Gratis · Nessuna pubblicità · I tuoi dati non si vendono mai',
      sb_get_small: 'Scarica su', sb_play_small: 'Disponibile su',
      trust_private: 'Privato di default', trust_offline: 'Sincronizzazione cifrata', trust_noads: 'Niente pubblicità, mai venduti', trust_langs: '6 lingue', trust_notmed: 'Non è un servizio medico',
      ...
      f1_t: 'Registro dosi e protocolli', f1_d: 'Registra ogni dose, imposta il calendario e mantieni uno storico pulito. Promemoria opzionali per il tuo calendario.',
      f2_t: 'Flaconi e calcolo siringa', f2_d: 'Monitora scorta e ricostituzione dei flaconi. Unità della siringa dai numeri che inserisci. L’aritmetica, fatta per te.',
      ...
      f6_t: 'Privato di default', f6_d: 'I tuoi dati si sincronizzano in sicurezza con il tuo account privato, con backup su tutti i tuoi dispositivi. Nessuna pubblicità, e i tuoi dati sanitari non si vendono né si condividono mai.',
      screens_eyebrow: 'Più da vicino', screens_h2: 'Calmo, chiaro e veloce da leggere.', screens_sub: "Scorri l'app.",
      cap0: 'I tuoi marcatori di laboratorio nel tempo', cap1: 'La tua giornata a colpo d’occhio', cap2: 'Protocolli e flaconi', cap3: 'Registri e dati', cap4: 'Energia e proteine', cap5: 'Un vero check di realtà',
      priv_eyebrow: 'Privacy', priv_h2: 'I tuoi dati restano tuoi.',
      priv_lead: 'I tuoi dati restano sul tuo dispositivo e si sincronizzano, cifrati in transito, con il tuo account privato — per avere backup e disponibilità su tutti i tuoi dispositivi.',
      priv_c1: '<b>Sul tuo dispositivo e sincronizzato</b> — con il tuo account privato e cifrato.',
      ...
      priv_stat: 'Mai<span> venduti o condivisi</span>',
      ...
      prem_1: 'Tutto di Gratis', prem_2: 'Protocolli illimitati', prem_3: 'Scansione illimitata di analisi e vaccini con IA — foto o PDF, qualsiasi lingua', prem_4: 'Esportazione PDF per il tuo medico', prem_5: 'Check di realtà e monitoraggio dei progressi', prem_7: 'Supporto prioritario', prem_8: 'Accumulo di dose e curve sieriche',
      prem_note: 'Mensile, annuale o una tantum a vita. Disdici quando vuoi.',
      faq_eyebrow: 'Domande', faq_h2: 'Domande frequenti',
      q1_q: 'DoseTrace è gratis?', q1_a: 'Sì. Registro dosi, promemoria, fino a 3 protocolli, i calcolatori, i diari di analisi e vaccini, la sincronizzazione cloud e una scansione con IA sono gratis. Premium sblocca protocolli e scansioni illimitati, esportazione PDF e monitoraggio — con prova gratuita.',
      q2_q: 'I miei dati sono privati?', q2_a: 'I tuoi dati restano sul tuo dispositivo e si sincronizzano, cifrati in transito, con il tuo account privato. Nessuna pubblicità e i tuoi dati sanitari non si vendono né si condividono mai. Puoi cancellare tutto dall’app quando vuoi.',
