...
(function () {
  ...
  var DICT = {
    en: {
      ...
      prem_1: 'Everything in Free', prem_2: 'Unlimited protocols', prem_3: 'Unlimited AI lab &amp; vaccine scanning — photo or PDF, any language', prem_4: 'PDF export for your doctor', prem_5: 'Reality-check &amp; progress tracking', prem_6: 'Cycle planner', prem_7: 'Priority support', prem_8: 'Dose accumulation &amp; serum-curve charts',
    ...
    es: {
      ...
      prem_1: 'Todo lo de Gratis', prem_2: 'Protocolos ilimitados', prem_3: 'Escaneo ilimitado de análisis y vacunas con IA — foto o PDF, cualquier idioma', prem_4: 'Exportación en PDF para tu médico', prem_5: 'Chequeo real y seguimiento del progreso', prem_6: 'Planificador de ciclos', prem_7: 'Soporte prioritario', prem_8: 'Acumulación de dosis y curvas séricas',
    ...
    pt: {
      ...
      prem_1: 'Tudo do Grátis', prem_2: 'Protocolos ilimitados', prem_3: 'Leitura ilimitada de exames e vacinas com IA — foto ou PDF, qualquer idioma', prem_4: 'Exportação em PDF para seu médico', prem_5: 'Teste de realidade e acompanhamento', prem_6: 'Planejador de ciclos', prem_7: 'Suporte prioritário', prem_8: 'Acumulação de dose e curvas séricas',
    ...
    fr: {
      ...
      prem_1: 'Tout le Gratuit', prem_2: 'Protocoles illimités', prem_3: 'Scan illimité d’analyses et vaccins par IA — photo ou PDF, toute langue', prem_4: 'Export PDF pour votre médecin', prem_5: 'Bilan réel et suivi des progrès', prem_6: 'Planificateur de cycles', prem_7: 'Support prioritaire', prem_8: 'Accumulation des doses et courbes sériques',
    ...
    de: {
      ...
      prem_1: 'Alles aus Kostenlos', prem_2: 'Unbegrenzte Protokolle', prem_3: 'Unbegrenztes KI-Scannen von Labor &amp; Impfungen — Foto oder PDF, jede Sprache', prem_4: 'PDF-Export für deine Ärztin/deinen Arzt', prem_5: 'Realitäts-Check &amp; Fortschritt', prem_6: 'Zyklusplaner', prem_7: 'Priorisierter Support', prem_8: 'Dosis-Akkumulation &amp; Serumkurven',
    ...
    it: {
      ...
      prem_1: 'Tutto di Gratis', prem_2: 'Protocolli illimitati', prem_3: 'Scansione illimitata di analisi e vaccini con IA — foto o PDF, qualsiasi lingua', prem_4: 'Esportazione PDF per il tuo medico', prem_5: 'Check di realtà e monitoraggio dei progressi', prem_6: 'Pianificatore di cicli', prem_7: 'Supporto prioritario', prem_8: 'Accumulo di dose e curve sieriche',
