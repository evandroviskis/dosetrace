...
// IMPORTANT: set this to the actual 1.0.2 App Store / Play go-live date before shipping,
// so every pre-launch user is grandfathered and only genuinely new signups are gated.
const PROFILE_GATE_SINCE = Date.parse('2026-09-10T00:00:00Z');
