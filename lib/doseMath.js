...
function massFromUnits(iu, amountMg, waterMl) {
  const u = parseFloat(iu);
  const a = parseFloat(amountMg);
...
module.exports = { unitsCompatible, normalizeDoseValue, formatML, computeDraw, dosesPerVial, massFromUnits, massParts };
