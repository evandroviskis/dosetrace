...
export const HALF_LIVES = {
  ...
  'Testosterone Undecanoate': { hours: 720, tier: 'clinical', source: 'Aveed/Nebido castor oil 33.9d', substance: 'testosterone' },
  ...
  'Nandrolone Phenylpropionate': { hours: 65, tier: 'studied', source: 'IM 2.7d', substance: 'nandrolone' },
  'Trenbolone Acetate': { hours: 72, tier: 'estimated', source: 'IM depot ~3d', substance: 'trenbolone' },
