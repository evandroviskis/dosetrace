...
export const HALF_LIVES = {
  ...
  'Progesterone': { hours: 20, tier: 'clinical', source: 'progesterone-in-oil IM — peaks ~8h, ~24-48h to baseline', substance: 'progesterone' },
  // Human PK published, not US-approved (studied)
  'Estradiol Cypionate': { hours: 120, tier: 'studied', source: 'ester t½ ~90h measured (PMID 22078184); activity 3-4wk — apparent', substance: 'estradiol' },
  ...
  'Kisspeptin-13': { hours: 0.1, tier: 'studied', source: 'kisspeptin-fragment human analogy (~min)' },
  ...
  'GDF-8': { hours: 24, tier: 'estimated', source: 'no human PK; latent propeptide complex — weak estimate' },
  'Myostatin': { hours: 1, tier: 'estimated', source: 'no human PK; free mature GDF-8 cleared fast' },
  ...
  'Dermorphin': { hours: 0.5, tier: 'estimated', source: 'no human PK; opioid heptapeptide, rapid' },
