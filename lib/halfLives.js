...
export const HALF_LIVES = {
  ...
  'Testosterone Suspension': { hours: 24, tier: 'estimated', source: 'aqueous — apparent, absorption-limited (duration 2-3d); no published injection PK', substance: 'testosterone' },
...
// Compounds that HAVE a reference half-life but are deliberately kept OFF the
// accumulation curve because a modeled "level" would mislead: insulins (rapid-
// acting is dosed to effect, not accumulation; an implied insulin level is the
// one place a misread is dangerous — DT council 2026-09-18, founder-approved).
...
// Returns null for CURVE_EXCLUDED compounds so they never chart a curve.
