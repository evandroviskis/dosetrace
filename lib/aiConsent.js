...
// All AI features (lab-report extraction, vaccine-card scanning, and vial-label
// scanning) share the same processor and the same consent.
//
// v2 (2026-09): added vial-label scanning as a covered data category, so the
// key is bumped — every user re-consents once with copy that names it.

import { Alert, Linking } from 'react-native';
import AsyncStorage from '@react-native-async-storage/async-storage';

const CONSENT_KEY = 'dosetrace_ai_extraction_consent_v2';
