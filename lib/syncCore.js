...
const TABLES = ['protocols', 'vials', 'dose_logs', 'biomarkers', 'vaccines', 'food_logs', 'reality_checks', 'calc_snapshots', 'calc_targets'];
  ...
  if (table === 'protocols') {
    db.runSync(
      ...
      [
        ...
        cloudRow.start_date, cloudRow.schedule_total, cloudRow.vial_valid_days || null, cloudRow.goal, cloudRow.notes, cloudRow.note || null,
