...
function familyOverride(style) {
  ...
  // which pushed long forms out of view. Pin a tighter line-height (~1.3×)
  // wherever a size is known and none was set — restoring the prior density
  // app-wide. Explicit lineHeights are respected (skipped).
  if (typeof flat.fontSize === 'number' && flat.lineHeight == null) {
    out.lineHeight = Math.round(flat.fontSize * 1.3);
  }
  return out;
}
