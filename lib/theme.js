...
export const DARK = {
  ...
  text: '#eef1f4',        // primary text (bright, very slightly softened)
  textMuted: '#aeb4bd',   // secondary text — a touch brighter for legibility
  textFaint: '#7e858f',   // hints / placeholders
